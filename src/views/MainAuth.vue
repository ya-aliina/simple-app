                    ...
                    <my-dialog v-model:show="dialogVisible" v-model:class="animation">
                        <div class="registration-form">
                            <div class="login" v-if="showLogin">
                                ...
                                <my-input placeholder="Укажите логин" v-model="login" id="login" type="text"
                                          class="form-control input"/>
                                <my-input placeholder="Введите пароль" v-model="password" id="password" type="password"
                                          class="form-control input"/>
                                <my-button class="button btn-primary" @click="onAuthClick">Войти</my-button>
                                <my-button @click="signInWithGoogle" class="button btn-light">
                                    <img class="google_img" src="../assets/google.png" alt="">
                                    <div>
                                        Войти через Google
                                    </div>
                                </my-button>
                            ...
                            <div class="registration" v-if="showRegistration">
                                <my-input placeholder="Адресс электронной почты" v-model="newEmail" id="newEmail"
                                          type="email" class="form-control input"/>
                                <my-input placeholder="Пароль" v-model="newPassword" id="newPassword" type="password"
                                          class="form-control input"/>
                                <my-input placeholder="Повторите пароль" v-model="newPasswordCopy" id="newPasswordCopy"
                                          type="password" class="form-control input"/>
                                <my-checkbox
                                    v-model="agreement"
                                    label="Регистрируясь, я соглашаюсь с
                                   Условиями использования продуктов Simple и принимаю Политику конфиденциальности."
                                />
                                <my-button class="button btn-primary" @click="doRegisterClick">
                                    Зарегистрироваться
                                </my-button>
                                <my-button @click="signInWithGoogle" class="button btn-light">
                                    <img class="google_img" src="../assets/google.png" alt="">
    ...
    methods: {
        ...
        doRegisterClick() {
            if (this.agreement !== true) {
                ...
                return alert('Для продолжения необходимо ваше согласие с условиями использования')
            }
            if (this.newPassword === this.newPasswordCopy) {
                ...
                return alert('Пароли не совпадают. Попробуйте еще')
            }
        },
        signInWithGoogle() {
