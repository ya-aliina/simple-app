			...
			<div class="form">
				...
				<div class="d-flex">
					...
					<my-select
						...
						v-model:selected="answerSelect"
					/>
				</div>
				<green-checkbox v-model="mailNotifications"> Получать уведомления на почту </green-checkbox>
...
export default {
	...
	data() {
		return {
			...
			radioOptions: ["М", "Ж"],
			answerRadio: "",
			selectOptions: ["Ученик", "Преподаватель"],
			answerSelect: "",
		};
	},
	methods: {
